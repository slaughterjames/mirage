...
'''
***BEGIN DESCRIPTION***
Type: Passive/Active - Description: Uses the Selenium web driver to take a screenshot of the target.
***END DESCRIPTION***
'''
def POE(POE):
    ...
    for port in http_data:
        ...
        try:
            ...
            driver.quit()
            print (colored('[*] Screenshot has been written to file here: ', 'green') + colored(output, 'blue', attrs=['bold']))
            if (POE.logging == True):
                newlogentry = 'Screenshot has been generated to file here: <a href=\"' + output + '\">  Port ' + str(port) + ' Output </a>'
